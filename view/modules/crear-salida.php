...
<section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Crear salida de productos</li>
    ...
    <div class="row">
      ...
      <div class="col-lg-5 col-xs-12">
        ...
        <div class="box box-success">
          ...
          <form role="form" method="post" class="formularioMovimientos">
            ...
            <div class="box-body">
              ...
              <div class="box">
                ...
                <!-- ENTRADA DEL CODIGO DEL MOVIMIENTO -->
                ...
                <div class="form-group">
                  <div class="input-group">
                    ...
                    if (!$movimientos) {
                      ...
                      echo '<input type="text" class="form-control" id="nuevaSalida"
                       name="nuevaSalida" value="101" readonly>';
                    } else {
                      ...
                      id="nuevaSalida" name="nuevaSalida" value="' . $codigo . '" readonly>';
          ...
          $guardarSalida = new MovimientosController();
