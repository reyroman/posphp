...
$('#daterangeVentas-btn').daterangepicker(
	{
	  ranges   : {
		'Hoy'       : [moment(), moment()],
	...
	function (start, end) {
	  $('#daterangeVentas-btn span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
  
	  var fechaInicial = start.format('YYYY-MM-DD');
 
	  var fechaFinal = end.format('YYYY-MM-DD');
  
	  var capturarRango = $("#daterangeVentas-btn span").html();
